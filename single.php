								...
								if (mysqli_num_rows($result) > 0) 
								{
									...
									<div class="details-left-info simpleCart_shelfItem">
										...
										<div class="price_single">
											<span class="actual item_price">'.$row['p_name'].'--    Rp. '.$row['p_price'].'</span>
										</div>
										<h2 class="quick"><b>Quick Overview</b></h2>
										<p class="quick_desc"><i> '.$row['p_desc'].'</i></p>
										<h3>Length</h3>
										<ul class="size">
											<li><a href="#">7</a></li>
											<li><a href="#">6</a></li>
											...
											<div class="quantity_box">
												...
												<div class="product-qty" >
													<select name="myselectbox" onchange="this.form.submit()" disabled>
											...
											<div class="single-but item_add">
											  <a href="addcart.php?mycart='.$row['p_id'].'&userid='.$id.'" type="button" class="btn btn-warning">Add to Cart</a>
												<a href="order.php?p='.$row['p_id'].'" type="button" class="btn btn-success">Buy Now</a>
												</div>
										</div>
									</div>
									';
