						...
						<div class="flexslider">
							  <ul class="slides">							  
								...
								<div class="col-md-7 single-text">
									...
									<br>
									<h4>Full Name:-</h4> <input type="text" size="50" name="fullname" title="Only alphabets allowed" required>
									<h4>Shipping Address:-</h4> <textarea rows="3" cols="30" name="address" required></textarea>
									<h4>Pin Code:-</h4> <input type="text" size="6" name="pincode" pattern="\d{5}" title="5 digit postal code" required>
									<h4>City:-</h4> <input type="text" size="15" name="city" pattern="[a-zA-Z]+" title="Only alphabets allowed" required>
									<h4>State:-</h4> <input type="text" size="30" name="state" title="Only alphabets allowed" required>
									<h4>Mobile No.:-</h4> <input type="tel" name="mobile" require title="Format: +62XXXXXXXXXX" value="+62" required>
									<br><br>
									<h2>Payment Method:</h2> <br>
									<input class="" type="radio" checked> Cash on Delivery (COD)<br>
									<input type="radio" disabled> Credit or Debit Card <i class="fa fa-cc-visa"></i> <i class="fa fa-cc-mastercard"></i>
									<br><br>';
					...
					<div class="w_sidebar">
						<div class="w_nav1">
							...
							<ul>
								...
								while($row = mysqli_fetch_assoc($result)) {
								echo '								
								<h1>'.$row['p_name'].'</h1><br><h2><a href="#">Price:</a></h2><h2><span>Rp. '.$row['p_price'].',-</span></h1>';
								}
								}
								?></li>
								<li></li>
