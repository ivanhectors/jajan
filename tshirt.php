...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="feedback.php">Feedback .</style></a> | Call us : +62 82 8694 3219</span>
			</div>
				...
				<div class="col-md-8 products-grid-left">
					...
					<?php					
						...
						if(isset($_GET['filter_price']))
						{
							...
							if($price == 1)
							$sql = " SELECT * FROM products WHERE p_price < 100000 AND p_type LIKE 'Tshirt'";
							if($price == 2)
							$sql = " SELECT * FROM products WHERE p_price BETWEEN 100000 AND 300000 AND p_type LIKE 'Tshirt'";
							if($price == 3)
							$sql = " SELECT * FROM products WHERE p_price BETWEEN 400000 AND 600000 AND p_type LIKE 'Tshirt'";
							if($price == 4)
							$sql = " SELECT * FROM products WHERE p_price > 600000 AND p_type LIKE 'Tshirt'";
								...
								while($row = mysqli_fetch_assoc($result)) 
								{
									...
									<div class="products-grd">
										<div class="p-one simpleCart_shelfItem prd">
											...
											<h4>'.$row["p_name"].'</h4>							
											<p><a class="item_add" href="addcart.php?mycart='.$row['p_id'].'&userid='.$id.'"><span class=" item_price valsa">Rp. '.$row["p_price"].' </span><img style="width:20px;" src="images/cartadd.svg"></img> </a></p>
											<div class="pro-grd">
							...
							if (mysqli_num_rows($result) > 0) 
							{
								...
								<div class="products-grd">
									<div class="p-one simpleCart_shelfItem prd">
										...
										<h4>'.$row["p_name"].'</h4>
										<p><a class="item_add" href="addcart.php?mycart='.$row['p_id'].'&userid='.$id.'"><span class=" item_price valsa">Rp. '.$row["p_price"].' </span><img style="width:20px;" src="images/cartadd.svg"></img></p>
										<div class="pro-grd">
											<a href="single.php?p='.$row['p_id'].'">Quick View</a>
										</div>
									</div>	
						...
						<section  class="sky-form">
							...
							<div class="row1 scroll-pane">
								...
								<form action="#" method="get" name="filter_price">
									...
									<label class="radio"><input type="radio" name="filter_price" value="4"><i></i>Above 600.000</label>
