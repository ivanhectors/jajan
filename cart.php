...
#shopping-cart table td{background-color:#fff;}
...
<div style="background-color:#18C9D2; width:85%; font-size:23px;">Shopping Cart<a id="btnEmpty" href="cart.php?empty=1"><p style="font-size:22px;">Empty Cart</p></a></div>
<table style="text-align:center; border-right: 5px solid " border="1">
<tbody style=" font-size:20px; border: 0px solid #18C9D2; ">
				<tr style="border: 0px solid #18C9D2;">
				...
				<th><center><strong>Action</strong></center></th>
								...
								<td style= "background-color:#fff; padding:1%" data-thumb="'.$row['c_image'].'">
									 <div class="thumb-image"><center> <img src="'.$row['c_image'].'" data-imagezoom="true" style="width:40%;" class="img-responsive" alt=""/></center> </div>
								</td>

								<td width=20% type="price"><strong>Rp. '.$row["c_price"].',-</strong></td>
								<td width=25%><a href="cart.php?remove='.$row["c_id"].'" type="button" class="btn btn-danger">Delete</a>
									<a href="order.php?p='.$row["c_p_id"].'" type="button" class="btn btn-success">Checkout</a>
								</td>
								</tr>';
								}
								}
								...
								{
									echo "<tr><td colspan=4><center><a><p>No Product Selected!</p></a></center></td></tr>";
								}								
								?>	
					<tr>
				...
				<td class="txt-heading" colspan="5" align="right"><strong>Total = </strong>Rp. <?php if($item_total==0) echo '0'; else echo $item_total; ?></td>
			</tr>
</tbody>
</table>	
</div>
