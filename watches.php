			...
			<div class="products-grids">
				<div class="col-md-8 products-grid-left">
					...
					if(isset($_GET['filter_price']))
					{
						...
						if($price == 1)
						$sql = " SELECT * FROM products WHERE p_price < 100000 AND p_type LIKE 'Watches'";
						if($price == 2)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 100000 AND 300000 AND p_type LIKE 'Watches'";
						if($price == 3)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 400000 AND 600000 AND p_type LIKE 'Watches'";
						if($price == 4)
						$sql = " SELECT * FROM products WHERE p_price > 600000 AND p_type LIKE 'Watches'";
						if (!$conn) {
