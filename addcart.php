...
<!--order strored in database-->
	<div class="products">
		...
		$sql = "SELECT * FROM products WHERE p_id = $mycart";
			...
			$sql = "Insert into cart (c_u_id,c_name,c_p_id,c_image,c_price,qty) values ($id,'$p_name',$mycart,'$p_image',$p_price,'$_POST[myselectbox]')";
			$result = mysqli_query($conn,$sql) or mysqli_error($conn);
			echo '<span style="color:#00ccff;text-align:center;"><h1><center> Product added to your cart!</center></h1></span>'; 
			?>
		<!--storing complete-->
</div>
