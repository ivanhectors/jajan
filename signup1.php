...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			<div class="top_right">
				<ul>
					<li><a href="signup1.php">Register Account</a></li>
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="#.php">Feedback .</style></a> | Call us : +62 823 8694 3219</span>
			</div>
...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			  <a href="#"><h1>Jajan<span>.Com</span></h1> </a>
		  </div>
...
<form action="acct_created1.php" method="post">
  ...
  <fieldset>
	...
	<label for="passw">Phone:</label>
    <input type="tel" pattern="[\+]\d{13}" id="mobile" name="user_mobile" require title="Format: +62XXXXXXXXXX" value="+62">    
