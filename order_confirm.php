...
<?php
	...
	if (isset($_POST['fullname']) && isset($_POST['product_id']) && isset($_POST['address']) && isset($_POST['pincode']) && isset($_POST['city']) && isset($_POST['state']) && isset($_POST['mobile']))
	{
		...
		$sql = "Insert into orders (p_id,fullname,address,pincode,city,state,mobile,date) values  ('$pid','$name','$add','$pin','$citi','$stat','$mob','$current_date')";
		...
		$sql = "Delete from cart where c_p_id = $pid AND c_u_id = $id";
				...
				echo '<span style="color:#00ccff;text-align:center;"><center><h1> Your Order has been Shipped!</h1></center></span>'; 
	}
?>
<!--//storing complete-->
</div>
