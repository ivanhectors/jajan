...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="#">Feedback .</style></a> | Call us : +62 823 8694 3219</span>
			</div>
...
<form action="checklogin1.php" method="post">
  ...
  <fieldset>
    ...
    <button type="submit"><h3>Login</h3></button>
		<br></br>
	<h5>New Member? Register<a style="color:red;" href="signup1.php"> here</a></h5><br>
</form>
	</div>
<!-- //products -->
			...
			<div class="footer-top">
				<div class="col-md-2 footer-left">
					...
					<ul>
						...
						<li><a href="administrator/loginform.php">Admin Page</a></li>		 
					</ul>
				</div>
