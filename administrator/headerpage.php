    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#administrator" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-database"></i>
            <span class="nav-link-text">Data Administrator</span>
          </a>
          <ul class="sidenav-second-level collapse" id="administrator">
            <li>
              <a href="daftaradmin.php">View Administrator</a>
            </li>
            <li>
              <a href="registrasi.php">Add New Administrator</a>
            </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Anggota">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseComponents" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Member's</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="daftaranggota.php">Data Member's</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseExamplePages" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Product's</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            <li>
              <a href="viewproducts.php">View Product's</a>
            </li>
            <li>
              <a href="addproducts.php">Add Product's</a>
            </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapsePages">
            <li>
              <a href="vieworders.php">View Order's</a>
            </li>
